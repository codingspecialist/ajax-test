...
<body>
	...
	<div class="container">
		...
		<div class="m_right">
			<div class="dropdown">
				...
				<div class="dropdown-menu">
				 	<a class="dropdown-item" href="#" onClick="getId()">번호순(내림차순)</a> 
					<a class="dropdown-item" href="#" onClick="getTitle()">제목순(내림차순)</a>
				</div>
			</div>
		</div>
		<table class="table">
		...
		<div id="test-box" class="test_box">
	...
	<script>
		async function getId(){
			...
			for(let board of parseResponse.data){
				$("#test-box").append("<p>"+board.id+" : "+board.title+"</p>");
			}
		}
